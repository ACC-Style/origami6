<template>
	<div class="p_4:md font_ui relative br-b_1 br_solid br_black-3">
		...
		<aside class="m-b_0:lg m-b_3:md m-b_2 m-t_2 m-t_2:md p-t_3">
			<a
						...
						<div class="flex_auto p-l_5:lg w_30:lg font_n2 font_n1:lg">
							<div class="flex_auto p-x_3">
								...
								>
								 ...
								 <span class="block font_light c_highlight font_n2">(Future State and should repeat this block for as many tag categories that are in the passed in data.)</span>
							</div>
						</div>
					</div>
				</div>
...
export default {
	props: {
		...
		valueCME: { type: Number, default: 0 },
		valueCNE: { type: Number, default: 0 },
		valueCOP: { type: Number, default: 0 },
		valueMOC: { type: Number, default: 0 },
