<template>
	<article
		class="br_radius br-1 br_black-2 br_solid font_copy  p-x_3 p_4 relative  shadow_1 m-b_4 " 
	>
		<div
			class="absolute r_n1:md r_4 t_n1 t_4:md text_center flex flex_column:md justify_end align-right font_1:md font_0"
		>
			<div
		...
		<div class="flex  flex_row:md flex_column">
				...
				<div class="flex_none justify_around font_n2 text_left flex_row flex_column:md flex p-l_4:md p-l_3" :class="{'p-t_4 m-t_2 p-t_0:md ':editorsPick || featured || previouslyRead || savedInLibrary }">
					<img
						:src="image"
						alt=""
						style="
			...
			<div class="flex_auto p-l_4:md p-l_3 p-r_5:md m-r_4:md">
				...
				<h1
					data-type="title"
					class="c_primary-n1 font_5:md font_3 font_display font_medium font_regular lh_1 m-y_2"
				>
					{{ title}}
				</h1>
				<p
				...
				>
					<a
						...
						class="link z_3 inline-block p-x_2"
