<template>
	<div class="p-x_5 p-y_4" :class="gridSize">
		<div
			v-for="(anouncement, index) in cards"
			:key="index"
			data-label="card"
		...
		>
			...
			<div data-name="content" class="p-t_4:lg p-t_3 p-b_4 p-x_4">
				...
				<div class="flex justified_around p-t_3">
					<Btn class="m-x_auto m-b_n5" :state="'primary'" :size="'medium'" :shadow="true"
					><span class="flex_auto">Learn More</span> </Btn>
				</div>
			</div>
		</div>
	</div>
